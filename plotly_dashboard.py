...
df["Lebenserwartung_numeric"] = df.apply(lambda x: get_expectancy_numeric(x["Lebenserwartung"]), axis=1)
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            html.Div([
                                ...
                                dcc.Dropdown(id='choose-life-expectancy', options=expectancies, multi=True, value=expectancies),
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                dbc.Badge("Filter Blumenart", color="primary", style={"marginRight": "1rem"}),
                                dbc.Badge("Filter Farbe", color="primary", style={"marginRight": "1rem"}),
                                # Balkendiagramm
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                ...
                                # Kreisdiagramm
                                dbc.Badge("Filter Kontinent", color="primary", style={"marginRight": "1rem"}),
                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                # Scatter
                                dbc.Badge("Filter Höhe", color="primary", style={"marginRight": "1rem"}),
                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                dbc.Badge("Filter Lebenserwartung", color="primary", style={"marginRight": "1rem"}),
                                dbc.Badge("Filter Klima", color="primary", style={"marginRight": "1rem"}),
                                dbc.Badge("Filter Kontinent", color="primary", style={"marginRight": "1rem"}),
...
def update_bar_chart_fig(continents, life_expectancies, flower_names, climate_number):
    ...
    fig = px.bar(dff, y="Lebenserwartung_numeric", x="Name", barmode="group", color="Herkunftskontinent")
    return fig
